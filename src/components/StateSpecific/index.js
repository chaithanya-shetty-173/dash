...
class SpecificState extends React.Component {
  ...
  renderLoadingView = () => (
    <div
      className="loading-container" // testid="stateDetailsLoader"
    >
      <Loader type="TailSpin" color="#0467d4" height={70} width={70} />
    </div>
  )

  renderStateRouteContainer = () => {
  ...
  renderView = () => {
    ...
    switch (apiStatus) {
      ...
      case apiStatusList.success:
        return this.renderStateRouteContainer()
      default:
        return null
    }
  }
    ...
    return (
      <div className="state-route">
        ...
        <div className="state-route-container">
          <div className="state-details">{this.renderView()}</div>
        </div>
        <Footer />
      </div>
    )
